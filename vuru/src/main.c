#include "index.h"
#include "utils.h"
#include "xbps/install.h"
#include "xbps/search.h"
#include "xbps/uninstall.h"
#include "xbps/upgrade.h"
#include <getopt.h>
#include <stdio.h>
#include <string.h>
...
static void print_version(void) { printf("vuru %s\n", VERSION); }
...
int main(int argc, char *argv[]) {
  ...
  static struct option long_options[] = {
      {"sync", no_argument, 0, 'S'}, {"update", no_argument, 0, 'u'},
      {"yes", no_argument, 0, 'y'},  {"version", no_argument, 0, 'v'},
